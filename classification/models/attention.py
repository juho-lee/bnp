...
class SelfAttn(MultiHeadAttn):
    def __init__(self, dim_in, dim_out, num_heads=8, skip_con=True):
        super().__init__(dim_in, dim_in, dim_in, dim_out,
                num_heads=num_heads, skip_con=skip_con)
