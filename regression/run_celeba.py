...
def main():
    ...
    args.root = os.path.join(results_path, 'celeba', args.model, args.expid)

    model, cmdline = load_module(f'models/celeba/{args.model}.py').load(args, cmdline)
...
def train(args, model):
    ...
    train_ds, eval_ds = CelebA(train=True), CelebA(train=False)
